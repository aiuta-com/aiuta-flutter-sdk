...
extension AiutaPlugin.Configuration {
    struct UserInterface: Decodable {
        ...
        enum SwipeToDismissPolicy: String, Decodable {
            case allowAlways, allowHeaderSwipeOnly, protectTheNecessaryPages
        }

        let presentationStyle: PresentationStyle
        let swipeToDismiss: SwipeToDismissPolicy
        let theme: Theme
    }
}
...
extension AiutaPlugin.Configuration.ImagePickerFeature {
    ...
    enum CameraStrings: Decodable {
        ...
        struct Custom: Decodable {
            let imagePickerCameraTitle: String
            let imagePickerCameraDescription: String
            let imagePickerCameraPositionTitle: String
            let imagePickerCameraPositionDescription: String
            let imagePickerCameraPositionCapture: String
        }
    }
}
...
extension AiutaPlugin.Configuration.ImagePickerFeature {
    enum PhotoGalleryIcons: Decodable {
        ...
        struct Custom: Decodable {
            let photoLibrary24: AiutaPlugin.Icon
        }
    }
    ...
    enum PhotoGalleryStrings: Decodable {
        ...
        struct Custom: Decodable {
            let imagePickerPhotoLibraryTitle: String
            let imagePickerPhotoLibraryDescription: String
        }
    }
}
...
extension AiutaPlugin.Configuration.ImagePickerFeature {
    ...
    enum PredefinedModelIcons: Decodable {
        ...
        struct Custom: Decodable {
            let predefinedModel24: AiutaPlugin.Icon
        }
    }
    ...
    enum PredefinedModelStrings: Decodable {
        ...
        struct Custom: Decodable {
            let imagePickerPredefinedModelTitle: String
            let imagePickerPredefinedModelDescription: String
            let imagePickerPredefinedModelSelectImageTitle: String
            let imagePickerPredefinedModelSelectImageDescription: String
        }
    }
}
...
extension AiutaPlugin.Configuration.ImagePickerFeature {
    enum UploadsHistoryStrings: Decodable {
        ...
        struct Custom: Decodable {
            let imagePickerUploadsHistoryTitle: String
            let imagePickerUploadsHistoryDescription: String
            let imagePickerDeletePhotoConfirmationTitle: String
            let imagePickerDeletePhotoConfirmationButton: String
        }
    }
...
extension AiutaPlugin.Configuration.TryOnFeature.LoadingPageFeature {
    enum LoadingPageStrings: Decodable {
        ...
        struct Custom: Decodable {
            let tryOnLoadingPageTitle: String
            let tryOnLoadingPageDescription: String
        }
    }
...
extension AiutaPlugin.Configuration.TryOnFeature.InputImageValidationFeature {
    enum InputImageValidationStrings: Decodable {
        ...
        struct Custom: Decodable {
            let tryOnValidationErrorTitle: String
            let tryOnValidationErrorDescription: String
            let tryOnValidationErrorTryAgain: String
        }
    }
}
...
extension AiutaPlugin.Configuration.TryOnFeature.FitDisclaimerFeature {
    enum FitDisclaimerIcons: Decodable {
        ...
        struct Custom: Decodable {
            let fitDisclaimer16: AiutaPlugin.Icon
        }
    }
...
extension AiutaPlugin.Configuration.TryOnFeature.FeedbackFeature {
    ...
    enum FeedbackIcons: Decodable {
        ...
        struct Custom: Decodable {
            let thumbsUp20: AiutaPlugin.Icon
            let thumbsDown20: AiutaPlugin.Icon
        }
    }
...
extension AiutaPlugin.Configuration.TryOnFeature.GenerationsHistoryFeature {
    enum GenerationsHistoryIcons: Decodable {
        ...
        struct Custom: Decodable {
            let generationsHistory24: AiutaPlugin.Icon
        }
    }
