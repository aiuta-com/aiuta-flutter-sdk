...
sealed class AiutaImagePickerPredefinedModelIcons {
  ...
  // Internal json staff
  factory AiutaImagePickerPredefinedModelIcons.fromJson(Map<String, dynamic> json) {
...
@JsonSerializable()
class AiutaImagePickerPredefinedModelIconsBuiltIn extends AiutaImagePickerPredefinedModelIcons {
  /// Creates an instance of the built-in image picker predefined model icons.
  AiutaImagePickerPredefinedModelIconsBuiltIn() : super(AiutaCustomizationType.builtIn);

  // Internal json staff
  factory AiutaImagePickerPredefinedModelIconsBuiltIn.fromJson(Map<String, dynamic> json) =>
      _$AiutaImagePickerPredefinedModelIconsBuiltInFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$AiutaImagePickerPredefinedModelIconsBuiltInToJson(this);
}
...
@JsonSerializable()
class AiutaImagePickerPredefinedModelIconsCustom extends AiutaImagePickerPredefinedModelIcons {
  ...
  // Internal json staff
  factory AiutaImagePickerPredefinedModelIconsCustom.fromJson(Map<String, dynamic> json) =>
      _$AiutaImagePickerPredefinedModelIconsCustomFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$AiutaImagePickerPredefinedModelIconsCustomToJson(this);
}
