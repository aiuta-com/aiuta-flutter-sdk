...
import com.aiuta.flutter.fashionsdk.domain.models.configuration.features.welcome.images.FlutterAiutaWelcomeScreenImagesBuiltIn
...
fun FlutterAiutaWelcomeScreenImages.toNative(
    ...
    return when (this) {
        is FlutterAiutaWelcomeScreenImagesBuiltIn -> error("TODO: Need support DefaultAiutaWelcomeScreenFeatureImages")
